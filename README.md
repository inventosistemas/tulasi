# v0.5.2 - 28/08/2017
[Carrinho-Pagamento] Atualizando carrinho (trazendo do server) quando um cupom é aplicado ou deletado, closes #422

# v0.5.1 - 25/08/2017
-[Cartão] Corrigindo os estilos nos títulos e nos inputs para futura round bold.
-[Footer] Trocando yaap para Invento Sistemas.

# v0.5.0 - 25/08/2017
-[Pagamento] Passando o cupom no request de salvar pedido

# v0.4.1 - 22/08/2017
- [Erro Cupom] Só faz POST request de cupom se existir um número de cupom; Closes #418;
- [Retirando Warnings] Retirando warnings e verificando impactos; Closes #380;
- [Carrinho-Confirmação] Trocando palavra Hortifruty por Hortifruti no aviso de confirmação de pagamento.
- [Sanitization] Removendo linhas código não mais necessárias
- [Carrinho de Compras] Chamando o action creator para obter um selectedDate no redux, em DeliverySelectComponent; Closes #415;
- [Carrinho] Deixando botão de finalizar habilitado quando é uma data sugerida, closes #411
- [Carrinho] Corrigindo bug que mostrava mensagem de erro ao fazer refresh no browser
- [Carrinho] Corrigindo problema de salvar cupom, closes #412
- [Carrinho] Alinhando imagem da mensagem com os períodos, closes #404

# v0.4.0 - 21/08/2017
- [Carrinho] Alterando a lógica de preencher o input de períodos, closes #406
- populando corretamente as informações de desconto na tela de pagamento, closes #402
- [Carrinho] Salvando cupom no redux e aplicando desconto no did mount do carrinho, closes #401
- [Carrinho] Mostrando parte de cupom de desconto apenas para usuário logados, closes #401
- Revert "[Carrinho] Alinhando imagem da mensagem com os períodos, closes #404"
- [Carrinho] Alinhando imagem da mensagem com os períodos, closes #404
- [Carrinho] corrigindo erro de lógica no drop down de períodos, closes #398
- [App] scroll para o topo da página ao redirecionar de uma rota para outra, closes #397
- [Pagamento] Implementando delete de cartões (considerando a nova lógica de preencher os campos com os dados de cartão salvo selecionado), closes #389
- [Pagamento] Preenchendo form com o cartão salvo
- [Carrinho] Substituindo mensagem de texto por imagem, embaixo de "escolha uma data", closes #392
- [Carrinho] Deixando input de cupom perto do botão de adicionar desconto, closes #391
- [Login] Aumentando maxLength do input de email, closes #390
- [Styling-Compra-Passo2] Alterando posição do botão continuar.
- [Carrinho] Corrigindo request de remover cupom de desconto; deixando adicionar e remover cupom em apenar um botão, e colocando mensagens de erro em modal
- [Carrinho] Colocando mensagem da data (vem da api agora)
- [Pagamento] Colocando bordar
- [Pagemento] Adicionando máscara do cartão na parte dos cartões salvos
- [Pagamento] Habilitando campos quando usuário ainda não escolheu se quer pagar com um cartão salvo ou com cartão novo
- [Pagamento] Removendo div de escolha entre cartão de débito e crédito
- AdicionarNovoEndereço] Deixando campo "complemento" não obrigatório
- [Carrinho-DataSugerida] Trazendo a data sugerida como default no campo "Escolha uma data"
- [Ajuste Carrinho de Compras] Permitindo que a compra finalize mesmo se o CEP não for área de entrega, usuário deve retirar na loja; Closes #365;
- [Ajuste Carrinho de Compras] Permitindo que a compra finalize mesmo se o CEP não for área de entrega, usuário deve retirar na loja; Closes #365;
- [Carrinho] Adicionando funcionalidade de data sugerida, closes #364
- [Fix] Fix no GET de articles em nossa casa
- [ParceirosAmigos] Deixando a seção de Produtores gerenciável, closes #367
- [ParceirosAmigos] Deixando a seção de parceiros amigos gerenciável
- [NossaCasa] fix no get de articles
- [NossaEquipe] conectando "Nossa equipe" com a API
- [PorQueTulasi] conectando "Por quê Tulasi" com a API
- [NossaCara] Conectando "Nossa Casa" com a API
- [Customization] Action/Reducers de GET do conteúdo do blog
- [Customization] Adicionando GET de buscar categorias
- [Ajuste Tulasi - Carrinho] Implementando utilização de cupom de desconto na compra; Closes #359;
- [Configuration] Criando variáveis de homologação em request Helper.
- [Carrinho-Cartoes] Ajustando CSS, fluxo e separando components do segundo passo do carrinho. CardForm.jsx; SelectCard.jsx, ShopppingCartSubtotalComponent e ShoppingCartPayment; Closes #361.
- [Carrinho-Cartoes] Criando reducers e actions de GET e DELETE de cartões do usuário; shoppingCartActions.js e shoppingCartReducer.js.
- [Styling] Adicionando Flexboxgrid ao Base.js e ao /css.
- [Localstorage] Corrigindo a questão do reload que não acontecia, quando o app era recarregado.
- [Tulasi-AdicionarEndereço] Limpando formulário e melhorando a mensagem de sucesso; Closes #376;
